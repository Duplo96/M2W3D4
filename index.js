...
const colorPrices = document.querySelectorAll( "prezzi")
for ( i = 0; i < colorPrices.length; i++){
    colorPrices[i].style.color = `rgb (${Math.round(Math.random() * 255)},
